        ...
        <div className="flex justify-between items-start">
          <div className="space-y-1">
            <Link
              ...
              className="text-lg font-medium text-gray-900 hover:text-[#C7511F] hover:underline line-clamp-2"
            >
              {product.Title}
            </Link>
            ...
            <div className="flex items-center gap-4 mt-4">
              <select
                ...
                className="bg-[#F0F2F2] border border-[#D5D9D9] rounded-md shadow-sm py-1 px-2 text-sm hover:bg-[#E3E6E6] cursor-pointer focus:ring-1 focus:ring-[#e77600] focus:border-[#e77600] outline-none"
              >
                {[...Array(10)].map((_, i) => (
          ...
          <div className="text-right">
            ...
            <div className="text-xs text-gray-500">Buy 2 items, get 2% off</div>
            <div className="text-xs text-amazon-link hover:underline cursor-pointer">
              Shop items
            </div>
          </div>
        </div>
